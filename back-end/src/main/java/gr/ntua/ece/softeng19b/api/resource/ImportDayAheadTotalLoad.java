...
public class ImportDayAheadTotalLoad extends EnergyResource {
                        ...
                        */
                        if (fi.getFieldName().equals("file")) {
                            ...
                            */
                            ...
                            long changedLines = dataAccess.insertDATLIntoDatabaseUsingLD("C:\\Users\\user\\Desktop\\2.0TL19-25-our-master\\back-end\\src\\main\\java\\gr\\ntua\\ece\\softeng19b\\api\\resource\\temp.csv");
                            file.delete();
                            //System.out.println(sb.toString());
                            //String[] toPass = sb.toString().split("\n");
                            //long changedLines = dataAccess.insertATLIntoDatabase(toPass);
                            long i = toPasss.length;
                            ImportResult X = new ImportResult(i,changedLines,dataAccess.countDATLFLines());  
