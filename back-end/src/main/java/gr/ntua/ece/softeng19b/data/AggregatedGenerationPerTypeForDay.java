...
public class AggregatedGenerationPerTypeForDay {
    ...
    private Float ActualGenerationOutputValue ;
    ...
    public Float getActualGenerationOutputValue() {
        return ActualGenerationOutputValue;
    }

    public void setActualGenerationOutputValue(Float ActualGenerationOutputValue) {
    ...
    public AggregatedGenerationPerTypeForDay() {
