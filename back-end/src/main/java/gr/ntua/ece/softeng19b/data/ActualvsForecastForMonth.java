...
public class ActualvsForecastForMonth {
    ...
    private Float ActualTotalLoadByDayValue;
    ...
    public Float getActualTotalLoadByDayValue() {
        return ActualTotalLoadByDayValue;
    }

    public void setActualTotalLoadByDayValue(Float ActualTotalLoadByDayValue) {
    ...
    public ActualvsForecastForMonth() {
