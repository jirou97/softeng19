...
public class AggregatedGenerationPerTypeForSpecificMonth extends EnergyResource {
    ...
    protected Representation get() throws ResourceException {
        ...
        LocalDate date = LocalDate.of(EnergyResource.parseYear(Year), EnergyResource.parseYear(Month), 1);
        ...
        try {
            ...
            List<AggregatedGenerationPerTypeForMonth> result = dataAccess.fetchAggregatedGenerationPerTypeForSpecificMonth(
                    areaName,
                    production,
                    resolution,
                    date
