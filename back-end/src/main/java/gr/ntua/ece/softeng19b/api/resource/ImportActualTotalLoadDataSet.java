...
public class ImportActualTotalLoadDataSet extends EnergyResource {
    ...
    public Representation post(Representation entity) throws ResourceException {
        ...
        try{
                ...
                if (MediaType.MULTIPART_FORM_DATA.equals(entity.getMediaType(), true)) {
                    ...
                    while (fileIterator.hasNext() && !found) {
                        ...
                        if (fi.getFieldName().equals("file")) {
                            ...
                            long changedLines = dataAccess.insertATLIntoDatabaseUsingLD("C:\\Users\\user\\Desktop\\2.0TL19-25-our-master\\back-end\\src\\main\\java\\gr\\ntua\\ece\\softeng19b\\api\\resource\\temp.csv");
                            file.delete();
                            //System.out.println(sb.toString());
                            //String[] toPass = sb.toString().split("\n");
                            //long changedLines = dataAccess.insertATLIntoDatabase(toPass);
                            long i = toPasss.length;
                            ImportResult X = new ImportResult(i,changedLines,dataAccess.countATLLines());  
            ...
            throw new ResourceException(Status.CLIENT_ERROR_BAD_REQUEST,e.getMessage(),null);
        }
    }
